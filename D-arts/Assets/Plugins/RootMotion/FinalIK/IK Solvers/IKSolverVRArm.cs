		...
		public class Arm: BodyPart {
			...
			protected override void OnRead(Vector3[] positions, Quaternion[] rotations, bool hasChest, bool hasNeck, bool hasShoulders, bool hasToes, bool hasLegs, int rootIndex, int index) {
				...
				if (!initiated) {
                    ...
                    Vector3 normal = forearmPosition - upperArmPosition;
                    Vector3 tangent = GetBendNormal(handPosition - upperArmPosition);
                    Vector3.OrthoNormalize(ref normal, ref tangent);
                    upperArmTwistAxis = Quaternion.Inverse(upperArmRotation) * tangent;
                } 
			...
			public void Solve(bool isLeft) {
                ...
                if (LOD < 1)
                {
                    Quaternion space = Quaternion.LookRotation(upperArm.solverRotation * upperArmTwistAxis, forearm.solverPosition - upperArm.solverPosition);
